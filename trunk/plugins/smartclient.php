...
function b_marquee_smartclient($limit, $dateformat, $itemssize)
{
	...
	include_once(ICMS_ROOT_PATH."/modules/" . SMARTCLIENT_DIRNAME . "/include/common.php");
	...
	If ($clientsObj)
	{
		for ($i = 0; $i < count($clientsObj); $i++ )
		{
			...
			$block[] = array('date' => '',
				...
				'author' => '',
				'title' => $title,
				'link' => "<a href='".ICMS_URL.'/modules/smartclient/client.php?id='.$clientsObj[$i]->id()."'>".$title.'</a>' );
		}
	}
	return $block;
}

...
function b_marquee_article($limit, $dateformat, $itemsize)
{
	...
	require_once(ICMS_ROOT_PATH."/modules/article/include/functions.php");
	$block = array();
	...
	foreach ($rows as $row)
	{
		...
		$delimiter = "/";
		$_art["link"] = "<a href=\"".ICMS_URL."modules/article/view.article.php$delimiter".$_art["art_id"]."/c".$_art["cat_id"]."\"><strong>".$_art["art_title"]."</strong></a>";

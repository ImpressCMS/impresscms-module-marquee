...
{
	include_once ICMS_ROOT_PATH.'/modules/smartsection/include/common.php';
	...
	if ($itemsObj)
	{
		for ($i = 0; $i < $totalItems; $i++ )
		{
			...
			$block[] = array('date' => $itemsObj[$i]->datesub(),
				...
				'title' => $title,
				'link' => "<a href='".ICMS_URL.'/modules/smartsection/item.php?itemid='.$itemsObj[$i]->itemid()."'>".$title.'</a>');
		}
	}
	return $block;
}
